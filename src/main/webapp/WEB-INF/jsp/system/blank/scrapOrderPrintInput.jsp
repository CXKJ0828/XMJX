        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <input id="workersubmitId" style="display:none" name="scrapFormMap.workersubmitId" type="text" value="${workersubmitId}" >
...
<script>
    ...
    function submitForm(){
        $('#ff').form({
            url:rootPath + '/blank/badprintorderEditEntity.shtml?origin=外协废品单',
            onSubmit: function(){
