...
<table style="width: 100%" id="contentCode1">
    ...
    <tr>
        <td style="text-align:center;"><span style="text-align:center;font-size: 18px;">${companyName}下料单</span></td>
    </tr>
    <tr>
        <td>
            <span style="float: left;font-size: 14px;">下料编号:${code}</span>
        ...
        <td>
            <table id="printRows" border="2" cellspacing="0" style="width: 100%;word-break:keep-all">
                ...
                <tr>
                    ...
                    <td style="font-size:15px;text-align: center">${order.remarks1}</td>
                    <td style="font-size:15px;text-align: center">${order.remarks2}</td>
                    </c:forEach>
            </table>
        </td>
    </tr>
