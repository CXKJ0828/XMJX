...
<table style="width: 100%" id="contentCode">
    ...
    <tr>
        <td>姓名:${badnoticeFormMap.userName}<span style="float: right;font-size: 14px;">日期:${nowDay}</span></td>
    </tr>
    <tr>
        <td>
            <table border="1" bordercolor="#a0c6e5" style="border-collapse:collapse;width: 100%">
                ...
                <tr style="height: 30px;">
                    <td style="text-align: center">${badnoticeFormMap.goodName}</td>
                    <td style="text-align: center">${badnoticeFormMap.contractNumber}</td>
                    <td style="text-align: center">${badnoticeFormMap.mapNumber}</td>
                    <td style="text-align: center">${badnoticeFormMap.badAmount}</td>
                    <td style="text-align: center">${badnoticeFormMap.goodSize}</td>
