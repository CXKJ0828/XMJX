    ...
    <form id="ff"  method="post">
        <table>
            <tr>
                <td>员工:</td>
                <td>
                    <input style="width:300px;" type="text"id="employee" ></input></td>
            </tr>
            <tr>
                <td>数量:</td>
...
<script>
    ...
    function printOrder() {
        ...
        $("#printOrder").window({
            ...
            modal: true,
            top:10,
            href: rootPath + '/heattreat/badnoticeOrderNoIdInputEmployeeUI.shtml?heattreatId='+getValueById('heattreatId')
            +"&employee="+getValueById("employee")
