        ...
        <td>
            <table border="1" bordercolor="#a0c6e5" style="border-collapse:collapse;width: 100%">
                <tr style="height: 30px;">
                    ...
                    <td style="width: 25%">${unqualifiedFormMap.goodName}</td>
                    <td style="text-align: center">图号:</td>
                    <td style="width: 25%">${unqualifiedFormMap.mapNumber}</td>
                    <td style="text-align: center">合同号:</td>
                    <td style="width: 25%">${unqualifiedFormMap.contractNumber}</td>
                </tr>
                <tr style="height: 30px;">
                    <td style="text-align: center">操作者:</td>
                    <td style="width: 25%">${unqualifiedFormMap.userName}</td>
                    <td style="text-align: center">扣款金额:</td>
                    <td style="width: 25%">${unqualifiedFormMap.money}</td>
                    <td style="text-align: center">数量:</td>
                    <td style="width: 25%">${unqualifiedFormMap.badAmount}</td>
                </tr>
                <tr style="height: 30px;">
