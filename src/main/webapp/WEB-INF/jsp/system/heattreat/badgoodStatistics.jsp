...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/heattreat/badgoodStatistics.js"></script>
...
<div data-options="region:'center'" style="height:150px;">
    ...
    <div id="tb" style="height:auto">
        ...
        完成日期:<input  id="starttime" style="width: 100px" type="text">
        至
...
<script>
    function printShow(origin) {
        ...
        var workersubmitHeattreatId=row.id;
        var goodId=row.goodId;
        var badAmount=row.badAmount;
        $("#printShow").window({
            width:600,
            title:origin,
            modal: true,
            top:20,
            href: rootPath + '/heattreat/badprintorderShowUI.shtml?workersubmitHeattreatId='+workersubmitHeattreatId
            +'&goodId='+goodId
            +'&badAmount='+badAmount
            +"&origin="+origin,
            onClose:function () {
