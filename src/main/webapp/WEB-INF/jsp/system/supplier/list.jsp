...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/supplier/list.js"></script>
<style>
    .tdShow{
        width:20%;
        text-align: left;
    ...
    <div class="easyui-tabs">
        <div title="基本资料" style="padding:1px">
            <table border="1"  cellspacing="0" style="border-color:gainsboro;">
                ...
                <tr>
                    <td class="tdShow" colspan="2"><span class="spanShow">地址：</span><input id="address" type="text"class="inputShow"  onchange="changeId(this.id)"></td>
        ...
        <div title="联系资料" style="padding:5px">
            <table border="1"  cellspacing="0" style="border-color:gainsboro;">
                ...
                <tr>
                    ...
                    <td class="tdShow"><span class="spanShow">邮编：</span><input id="zipCode" type="text"class="inputShow"  onchange="changeId(this.id)"></td>
                </tr>
                </tbody>
            </table>
        </div>
