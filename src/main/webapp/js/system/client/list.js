...
$(function() {
    $('#tt').datagrid({
        url:rootPath + '/client/findByPage.shtml',
        title:'数据展示',
        iconCls:'icon-ok',
        toolbar: '#tb',
        idField:'id',
        ...
        onDblClickRow:function (rowIndex, rowData) {
            ...
            setContentToInputById("taxFreeRatio","");
            setContentToInputById("taxFreeRatioOld","");
        ...
        columns:[[
            ...
            {field:'taxFreeRatio',title:'不含税比率',width:150,align:'center',editor:'text'},
            {field:'taxRate',title:'税率',width:100,align:'center',editor:'text'},
            ...
            {field:'taxFreeRatioOld',hidden:true,title:'taxFreeRatioOld',width:150,align:'center',editor:'text'},
            {field:'taxRateOld',hidden:true,title:'taxRateOld',width:100,align:'center',editor:'text'},
        ]],
...
function  del() {
    ...
    if(ids!=""){
        communateGet(rootPath +'/client/deleteEntity.shtml?ids='+ids,function back(data){
...
function  save() {
   endEditDatagridByIndex('tt',editId)
    ...
    if(rows.length>0){
        communatePost(rootPath +'/client/addEntity.shtml',ListToJsonString(rows),function back(data){
            reloadDatagridMessage('tt');
        });
    }else{
